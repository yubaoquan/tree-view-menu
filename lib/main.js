...
export default Object.assign({}, {
    ...
    async onIgnore(msg) {
        // test
        const ignorePattern = await ignoreLogic.getIgnorePattern(this.currentPath)
        console.info(ignorePattern)
        return
        // test
        let targetType = 'file'
        if (_.isDirectorySync(this.currentPath)) {
        ...
        if (ignoreLogic.isRepoRoot(this.currentPath)) {
            return notify.error(
    ...
    onIgnoreConfirm(ignoreType) {
        ignoreLogic.ignore(this.currentPath, ignoreType)
    },
})

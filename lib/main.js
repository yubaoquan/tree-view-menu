...
export default Object.assign({}, findAndReplace, {
    config: {
        ...config.menuBtns,
        mode: {
            order: 1,
    ...
    onSearchInProject() {
        ...
        this.findAndReplace.findInProject(node, this.currentPath, rootPath);
        this.menu.hide();
    },
    onCopyFullPath() {

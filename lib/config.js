...
const buttons = [
    {
        ...
        description: 'Find text in current file by package `Find And Replace`',
    }, {
        value: 'findInDirectory',
        description: 'Find text in current directory by package `Find And Replace`',
    },
];

...
const buttons = [
    {
        ...
        value: 'revealActiveFile',
        description: `Reveal the active file in the editor `,
    },
]
...
export default {
    ...
    terminalOpenPathOptions: [
        {
            value: 'currentPath',
            description: 'Open the terminal at current path',
        }, {
            value: 'root',
            description: 'Open the terinal at project root',
        },
    ],
}
